...
public class dad3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dad3);

        TextView dad = findViewById(R.id.text5);
        String mom = getIntent().getStringExtra("mom");
        dad.setText("Hello Dad, it's your turn");
        ...
        public void next(){
            ...
            Intent intent = new Intent(this, bgene.class);
            intent.putExtra("mom1",mom);
